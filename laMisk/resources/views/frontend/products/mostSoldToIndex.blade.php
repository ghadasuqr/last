<!-- ============================================================================================= -->
<?php
$items= App\Http\Controllers\frontend\productsCtrl::mostSoldToIndex();
...
<div class="MostSold my-5">
    <div class="container">    
        <h5 class=" sectionTitle ">  الاكثر مبيعا  </h5>
        <div class="row">
        ...
        <!--  span to save id if found , to ckeck if the user logeed in to show class for addtowishlist -->
            ...
            <div class="product-grid box-shadow ">
                        ...
                        <div class="product-content">
                            ...
                            <h3 class="title"><a> <span> عدد ( {{$item->totalQty}} )</span></a></h3>
                            <div class="price">
                            <?php $price=App\Cart::getItemPrice($item->code);?>
                            @if(App\Sale::isCurrent($item->code))
